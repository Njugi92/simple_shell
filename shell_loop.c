#include "shell.h"
/**
*       hsh - the function main shell loop
*       @info: this is the parameter & return info struct
*       @av: it is the argument vector from main()
*
...
/**
*       find_builtin - the function finds a builtin command
...
/**
*       find_cmd - the function finds a command in PATH
*       @info: it is the parameter & return info struct
*
*       Return: void
*/
...
/**
*       fork_cmd - the function forks a an exec thread to run cmd
*       @info: it is the parameter & return info struct
*
*       Return: void
*/
