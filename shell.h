...
* @environ:it's custom modified copy of environ from LL env
...
* @histcount:this is the history line number counting
*/
...
int env_changed;
int status;
char **cmd_buf; /*it is a pointer to cmd ; chain buffer, for memory mangement */
